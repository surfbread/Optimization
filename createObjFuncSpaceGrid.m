...
function Grid = createObjFuncSpaceGrid(bestIndividuals,nGrid,alpha)

    % Non-Dominated Solutions to form Grid
    sol = [bestIndividuals.ObjFuncVal];
    ...
    % Create Empty Grid
    empty_grid.LB = []; % Lower Boundary
    empty_grid.UB = []; % Upper Boundary
